                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="lead_type" id="lead_type" class="select2 form-control custom-select" required>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="lead_source" id="lead_source" class="select2 form-control custom-select" required>
                                    <option value="">Select Option</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="assigned_to" id="assigned_to" class="select2 form-control custom-select" required>
                                    <option value="">Select Option</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="lead_status" id="lead_status" class="select2 form-control custom-select" required>
                                    <option value="">Select Option</option>
