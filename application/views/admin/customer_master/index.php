<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('admin/customer_master') ?>">Customer Master</a>
            </li>
            <li class="active">
                <strong>Add</strong>
            </li>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <form method="post" class="form-horizontal"
                                action="<?php echo base_url('admin/customer') ?>">
                                <!-- Error Alert -->
                                ...
                                <div class="form-group">
                                    <label><b class="text-danger">*</b>Customer Type:</label>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="customer_name" id="customer_name"
                                    ...
                                    placeholder="Enter Name" value="<?php echo set_value('customer_name'); ?>">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label><b class="text-danger">*</b>Contact Person name:</label>
                                <input type="text" name="contact_person_name[]" id="contact_person_name"
                                    class="form-control <?php echo (form_error('contact_person_name')) ? 'is-invalid' : '' ?>"
                                    placeholder="Enter Contact Person Name"
                                    value="<?php echo (!set_value('contact_person_name')) ? '' : set_value('contact_person_name'); ?>">
                                <?php echo form_error('contact_person_name', '<div class="invalid-feedback">', '</div>'); ?>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="contact_no_2[]" id="contact_no_2"
                                    class="form-control <?php echo (form_error('contact_no_2')) ? 'is-invalid' : '' ?>"
                                    placeholder="Enter Alternate Contact No"
                                    value="<?php echo (!set_value('contact_no_2')) ? '' : set_value('contact_no_2'); ?>"
                                    maxlenght="10">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <button class="btn btn-white" type="button"
                                    onclick="window.location.href='<?php echo base_url('admin/Customer_Master'); ?>'">Cancel</button>
